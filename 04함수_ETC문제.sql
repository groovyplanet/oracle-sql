...
SELECT FIRST_NAME, LAST_NAME, REPLACE(HIRE_DATE,'/','') FROM EMPLOYEES ORDER BY FIRST_NAME;
...
SELECT * FROM EMPLOYEES;
SELECT RPAD(SUBSTR(FIRST_NAME, 1,3),LENGTH(FIRST_NAME),'*')AS NAME, LPAD(SALARY , 10 , '*') FROM EMPLOYEES WHERE JOB_ID='IT_PROG';
