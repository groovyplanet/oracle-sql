--PLSQL(프로그램 SQL)
--익명블록
--실행을 F5로 컴파일 시켜서 실행시킵니다. (CTRL + 엔터 X)
...
DECLARE
    NAME VARCHAR2(30);
    SALARY NUMBER;
    LAST_NAME EMPLOYEES.LAST_NAME%TYPE; --EMP 테이블의 LAST_NAME 컬럼과 동일한 타입으로 선언하겠음.
...
------------------------------------
--2008년 입사한 사원의 평균을 구해서 새로운 테이블에 INSERT
...
INSERT INTO EMPS_IT(EMPLOYEE_ID,LAST_NAME,EMAIL,HIRE_DATE,JOB_ID)
       VALUES(NUM+1, 'Steven', 'Steven Jobs',SYSDATE,'CEO');
